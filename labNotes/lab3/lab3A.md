...
- `env_setup_vm`: use `kern_pgdir` as a template.
...
This exercise is not hard, if you read the manual in Exercise 3 carefully and you fully undersatnd how the interrupt handling works in xv6 works. In particular, you should be clear about what hardware and software does respectively in the process.
